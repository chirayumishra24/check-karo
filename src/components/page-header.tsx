...
export function PageHeader({
  ...
  const { t } = useI18n();
  return (
    <section className="container-page animate-rise pt-10 pb-8 sm:pt-14">
      ...
      {subtitle ? <p className="mt-3 max-w-2xl text-base text-muted-foreground sm:text-lg">{t(subtitle)}</p> : null}
    </section>
  );
}
